...
export default function StartDocsPage() { return <>
  ...
  <p className="lede">Family Drill is bot-first. The organizer installs the bot, verifies their account, and chooses a schedule. Relatives receive surprise practice emails without a separate verification flow.</p>
  <div className="doc-options">
    ...
    <section><b>02 · Hosted here</b><h2>Open a trusted reveal</h2><p>Every surprise email points back to this site for a clear reveal and short lesson. No credentials or private information are requested.</p><Link className="text-link" href="/d/drill-leo">Try a demo reveal →</Link></section>
