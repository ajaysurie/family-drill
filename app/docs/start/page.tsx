...
export default function StartDocsPage() { return <>
  ...
  <div className="doc-options">
    <section><b>01 · Hosted</b><h2>Sign in to get your install code</h2><p>Go to <a href={HOSTED_LOGIN_URL}>{HOSTED_LOGIN_URL}</a>. After you verify your email, you&apos;ll land on your install code.</p><a className="text-link" href={BOT_INSTALL_URL}>Install the Family Drill bot →</a><br /><Link className="text-link" href="/docs/bot">See setup instructions →</Link></section>
