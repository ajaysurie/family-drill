...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    <header><Link href="/" className="brand"><Image src="/brand/house-icon.svg" alt="" width={34} height={34} /> Family Drill</Link><nav aria-label="Main navigation"><Link href="/docs/start">How it works</Link><Link className="nav-cta" href="/docs/bot">Install bot</Link><Link href="/login">Organizer sign in</Link></nav></header>
    <main>{children}</main>
