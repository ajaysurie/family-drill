...
export default function Home() {
  return <>
    ...
    <section className="bot-card"><div><span className="eyebrow">Start with the bot</span><h2>Ready to give your family a practice run?</h2><p>Install the published Family Drill bot, then add family names and emails in its chat, not on the website.</p></div><a className="button secondary" href={BOT_INSTALL_URL}>Install the Family Drill bot →</a></section>
  </>;
}
