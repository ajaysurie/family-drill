...
export default async function InstallPage() {
  ...
  return <section className="card install"><span className="eyebrow">Organizer verified</span><h1>Connect your bot.</h1>
    ...
    <p className="help">Keep this code private. It connects the bot to your organizer account.</p>
    <Link className="button" href={BOT_INSTALL_URL}>Open the Family Drill bot</Link>
